...
$columns = array(
    array(
        ...
        'formatter' => function( $d, $row ) {
            //return //'$'.number_format($d);
//            return '<button onclick="fn_loadqedt_edtboxedtboxone(\''.$d.'\',\'agregar\',this)" type="button" class="estbtn863467655 btn bg-gray waves-effect">
...
//                                    <i class="material-icons">trending_up</i><span>Modificar</span></button>';
	...
	array( 'db' => 'email', 'dt' => 'email' ),
	array( 'db' => 'nombrecompleto',   'dt' => 'nombrecompleto' ),
	array( 'db' => 'telefono',     'dt' => 'telefono' ),
