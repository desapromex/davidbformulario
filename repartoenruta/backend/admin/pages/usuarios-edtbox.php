        ...
        <div class="card">
            ...
            <div class="body">
                ...
                if('agregar'==strtolower(trim($sqvraction))) {
                    ...
                    $stmtq = $dbh->prepare("SELECT * FROM usuario WHERE id=?");
                ...
                <form id="formqoneq">
                    ...
                    <input id="tipousuariogrupo" name="tipousuariogrupo" value="repartidor" type="hidden">
                    ...
                    <div class="est7456coldoble593">
                        ...
                        ?>
                        <label for="<?php echo $sqvrfeldtconame;?>">Email</label>
                        ...
                        <?php
                        $sqvrfeldtconame='nombrecompleto';
                        ...
                        ?>
                        <label for="<?php echo $sqvrfeldtconame;?>">Nombre Completo</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input  id="<?php echo $sqvrfeldtconame;?>" name="<?php echo $sqvrfeldtconame;?>" <?php echo $sqvrfeldtcoreadonly;?>  <?php echo $sqvrfeldtcodisabled;?> type="text" class="form-control" placeholder="" value="<?php echo $sqvrfeldtcoenfo;?>">
                            </div>
                        ...
                        ?>
                            ...
                            ?>
                            <label for="<?php echo $sqvrfeldtconame;?>">Password</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input  id="<?php echo $sqvrfeldtconame;?>" name="<?php echo $sqvrfeldtconame;?>" <?php echo $sqvrfeldtcoreadonly;?>  <?php echo $sqvrfeldtcodisabled;?> type="text" class="form-control" placeholder="" value="<?php echo $sqvrfeldtcoenfo;?>">
                                </div>
                        ...
                        ?>
                            ...
                            ?>
							<label for="<?php echo $sqvrfeldtconame;?>">Password (para cambiarlo,escribe aqui el nuevo password)</label>
							<div class="form-group">
                                <div class="form-line">
									<input id="changepassword" name="changepassword" type="hidden" value="changepassword">
                                    <input  id="<?php echo $sqvrfeldtconame;?>" name="<?php echo $sqvrfeldtconame;?>" <?php echo $sqvrfeldtcoreadonly;?>  <?php echo $sqvrfeldtcodisabled;?> type="text" class="form-control" placeholder="" value="<?php echo $sqvrfeldtcoenfo;?>">
                                </div>
                            </div>
						<?php 
                    ...
                    <div class="est7456coldoble593">
                        ...
                        ?>
                        <label for="<?php echo $sqvrfeldtconame;?>">Telefono</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input  id="<?php echo $sqvrfeldtconame;?>" name="<?php echo $sqvrfeldtconame;?>" <?php echo $sqvrfeldtcoreadonly;?>  <?php echo $sqvrfeldtcodisabled;?> type="text" class="form-control" placeholder="" value="<?php echo $sqvrfeldtcoenfo;?>">
                            </div>
                        ...
                        ?>
                        <label for="<?php echo $sqvrfeldtconame;?>">Direccion</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input  id="<?php echo $sqvrfeldtconame;?>" name="<?php echo $sqvrfeldtconame;?>" <?php echo $sqvrfeldtcoreadonly;?>  <?php echo $sqvrfeldtcodisabled;?> type="text" class="form-control" placeholder="" value="<?php echo $sqvrfeldtcoenfo;?>">
                            </div>
