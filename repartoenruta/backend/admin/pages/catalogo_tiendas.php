...
$(document).ready(function() {			
	$('#examplesqboneuno').DataTable( {
		...
		"serverSide": true,
		"ajax": {
			"url": "catalogo_tiendas/serversidepostserverside.php",
			"type": "POST"
		},
		"columns": [
			{ "data": "nombretienda" },
			...
			{ "data": "telefono" },
			{ "data": "fechahora_hwa" },
			{ "data": "fechahoranumeritime_hwa" }
		]
	} );
} );
</script>

<div class="modal fade in" id="largeModal" tabindex="-1" role="dialog" style="/* opacity: 1; */display: block;opacity: 1;padding-right: 17px;background: #00000087;">
...
">
                        ...
                        <div class="modal-footer">
							<button type="button" class="btn btn-primary waves-effect">PRIMARY</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                        </div>
                    </div>
                </div>
            </div>