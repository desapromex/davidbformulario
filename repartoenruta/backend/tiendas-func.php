...
$sdvbbfparname = 'nombretienda';
$sdvbbfparinfoq = '';
if (isset($_REQUEST[$sdvbbfparname])) {
//$sdvbbfparinfoq=$_REQUEST[$sdvbbfparname];
    $sdvbbfparinfoq = trim($_REQUEST[$sdvbbfparname]);
}
$nombretienda = $sdvbbfparinfoq;
...
if (trim($sdvbbfparinfoq) != '') {
    ...
    header("HTTP/1.0 202 ErrorqServerq");
    echo '["el dato: nombre ,es obligatorio"]';
    die();
}
...
//$sqvrsqdvbsdqsvvs = substr($sqvrsqdvbsdqsvvs, 0, strlen($sqvrsqdvbsdqsvvs) - 1);
        ...
        $stmt = $dbh->prepare("INSERT INTO tienda (" . $sqvrsqdvbsdqsvvs . ") VALUES (" . $sqvrsqdpdpqpsp . ")");
...
//$sqvrsqdvbsdqsvvs = substr($sqvrsqdvbsdqsvvs, 0, strlen($sqvrsqdvbsdqsvvs) - 1);
        ...
        // var_dump("UPDATE  tienda SET " . $sqvrsqdvbsdqsvvs . ") VALUES (" . $sqvrsqdpdpqpsp . ")");

// $stmt = $dbh->prepare("UPDATE  tienda SET " . $sqvrsqdvbsdqsvvs . ") VALUES (" . $sqvrsqdpdpqpsp . ")");
...
//        $objsqrowreq
//
//        $stmt = $dbh->prepare("UPDATE  tienda SET " . $sqvrsqdvbsdqsvvs
//            . "  WHERE id=?" );
//
